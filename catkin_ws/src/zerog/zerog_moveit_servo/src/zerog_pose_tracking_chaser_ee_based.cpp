...
static const std::string LOGNAME = "chaser_tracking_example";
...
private:
  void statusCB(const std_msgs::Int8ConstPtr& msg)
  {
    ...
    if (latest_status != status_)
    {
      ...
      ROS_INFO_STREAM_NAMED(LOGNAME, "chaser Servo status: " << status_str);
    }
  }
...
public:
  ...
  {
    delta_pose_sub = nh.subscribe<geometry_msgs::PoseStamped>("/chaser_frame_pose", 50, &FrameSubscriber::deltaposCallback, this);
  }
...
int main(int argc, char** argv)
{
  ...
  auto initial_pose_msg = ros::topic::waitForMessage<geometry_msgs::PoseStamped>("/chaser_frame_pose", nh);
